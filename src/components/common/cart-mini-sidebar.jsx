          ...
          <div className="cartmini__top-wrapper">
            ...
            {cart_products.length > 0 && <div className="cartmini__widget">
              {cart_products.map((item) => (
                <div key={item.itemID} className="cartmini__widget-item">
                  ...
                  <div className="cartmini__content">
                    <h5 className="cartmini__title">
                      <Link href={`/product-details/${item.itemID}`}>{item.title}</Link>
                    </h5>
                  ...
                  <a onClick={() => handleRemovePrd({ title: item.title, id: item.itemID })} className="cartmini__del cursor-pointer"><i className="fa-regular fa-xmark"></i></a>
                </div>
              ))}
            </div>}
            {/* if no item in cart */}
